...
The VertiWiki 0.2.5 theme engine is built on modern **CSS Custom Properties (Design Tokens)** compatible with standard Tailwind CSS v4 and shadcn/ui architectures.
