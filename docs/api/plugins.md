...
VertiWiki 0.2.5 features an extensible, async-first **Pipeline Architecture** allowing developers to create custom plugins and extensions easily.

---

## 🧩 Built-in Plugins in VertiWiki 0.2.5
...
* Status: :badge[v0.2.5]{type=primary}
