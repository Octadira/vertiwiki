...
### **v0.2.3** (Current Active Release — August 2026) :badge[Latest]{type=success}
...
* 🛡️ **Pure `verti-` Namespace**: Unified prefix across all CSS variables (`--verti-*`), DOM containers (`#verti-app`), UI components, and all 12 plugins.
