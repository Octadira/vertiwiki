# Theme System & Custom Templates

VertiWiki 0.2.3 comes with a powerful, **100% offline, zero-reload theme engine** based on modern CSS custom properties and standard Tailwind / shadcn design tokens.
