...
# Welcome to VertiWiki :badge[v0.2.6]{type=primary} :badge[AI & AEO Ready]{type=success}
...
> [!NOTE]
> You are currently viewing the modernized **VertiWiki 0.2.6** engine. It renders pure Markdown directly in your browser with zero build steps needed on the server.
