...
# Welcome to VertiWiki :badge[v0.6.1]{type=primary} :badge[AI & AEO Ready]{type=success}
...
> [!NOTE]
> You are currently viewing the modernized **VertiWiki** engine. It renders pure Markdown directly in your browser with zero build steps needed on the server.
