# Getting Started
* [Welcome to VertiWiki](index.md)
* [Installation Guide](docs/getting-started/installation.md)
* [Modern Features (2026+)](features.md)
* [Theme System & Templates](themes.md)
* [Visual Sitemap](sitemap.md)

# Guides & Authoring
* [Authoring Guide](docs/guides/authoring.md)
* [Multi-Language (i18n) Setup](docs/guides/multi-language.md)
...
* [Core Architecture Overview](docs/architecture/overview.md)
* [Theme Engine & Tokens](docs/architecture/theme-engine.md)
* [Plugin Development API](docs/api/plugins.md)
